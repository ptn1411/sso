...
const Login = loadable(() => import(/* webpackChunkName: "Login" */ './Login/index'), {fallback: <Loading/>})
const Register = loadable(() => import(/* webpackChunkName: "Login" */ './Register/index'), {fallback: <Loading/>})
